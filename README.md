...
Try these prompts:
    ...
    "What is the genre of 'Animal Farm'?" (Expected: Satire)

    "Which author is American?" (Expected: Isaac Asimov)

    "Give me details about 'I, Robot'." (Expected to synthesize details like author, genre, publication year)

The response will now include the user_prompt, the sparql_query generated by the LLM, the raw_query_results from the knowledge graph, and most importantly, the human-readable agent_response synthesized by the LLM.
